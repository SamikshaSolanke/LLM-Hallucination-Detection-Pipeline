...
FLASH_RESPONSES_JSON: Path = RESULTS_DIR / "gemini_flash_responses.json"
PRO_RESPONSES_JSON  : Path = RESULTS_DIR / "gemini_pro_responses.json"

SCORED_RESULTS_JSON : Path = RESULTS_DIR / "scored_results.json"

HF_DATASET_NAME     : str  = "truthful_qa"
HF_MC_CONFIG        : str  = "multiple_choice"   # has mc1_targets / mc2_targets
